...
public class DbUtil {
    ...
    public static String url = "jdbc:mysql://localhost:3306/train_member?useUnicode=true&characterEncoding=utf8&useSSL=true";
    public static String user = "train_member";
    public static String password = "train_member";
